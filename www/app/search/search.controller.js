(function() {
  ...
  function SearchController($scope) {
    ...
    $scope.restSearch = function () {
      // TODO: update to call yelp api
      console.log('restSearch called');
      vm.restResults = sampleYelpData.businesses; //eslint-disable-line
      console.log('vm.restResults', vm.restResults);
    };
    console.log('this inside restSearch', this);
  }
})();
